...
<html lang="es">
    ...
    <body>
        ...
        <main id="contenedorMostrar">
            <div id="titulo">ejercicio04pdo.php</div>
            <?php
        ...
        <footer class="pie-pagina">
            <div class="contenido-footer">
                <div class="texto-legal">
                    ...
                    <p class="autor"><a href="https://oscarpozvil.ieslossauces.es" target="_blank">Óscar Pozuelo Villamandos.</a> Fecha de Actualización: 23-03-2026</p>
                </div>
