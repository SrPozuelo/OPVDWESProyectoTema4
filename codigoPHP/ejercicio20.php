...
<html lang="es">
    ...
    <body>
        ...
        <main id="contenedor" class="contenedor20">
            <div id="titulo">20-Convertir la LibreriaValidacionFormularios.php en una clase ValidacionFormularios.php..</div>
            <?php
                /*
                ...
                * @since 10-03-2026 
                * Ejercicio 20
                * Convertir la LibreriaValidacionFormularios.php en una clase ValidacionFormularios.php.
                */
                highlight_file("../core/080126libreriaValidacion.php");
            ?>
        </main>
